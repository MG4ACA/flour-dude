    ...
    <div class="container mx-auto max-w-7xl">
          ...
          >
            ...
            <template #empty>
              <div class="text-center py-8">
                ...
                <p class="text-vintage-text font-body">No products found. Click "Add Product" to create one.</p>
              </div>
            </template>
            ...
            <Column field="category_id" header="Category" :sortable="true" style="width: 15%">
              <template #body="slotProps">
                <Tag :value="getCategoryName(slotProps.data.category_id)" class="bg-vintage-accent text-white" />
              </template>
            </Column>
        ...
        <TabPanel header="Categories Management">
          ...
          >
            <template #empty>
              <div class="text-center py-8">
                <i class="pi pi-inbox text-5xl text-vintage-accent mb-3"></i>
                <p class="text-vintage-text font-body">No categories found. Click "Add Category" to create one.</p>
              </div>
            </template>
      ...
      >
        <form @submit.prevent="saveProduct" class="space-y-4">
          <div class="flex flex-column gap-2">
            <label for="productName" class="font-body font-semibold text-vintage-text">Product Name *</label>
            <InputText 
              id="productName" 
          ...
          <div class="flex flex-column gap-2">
            <label for="productDescription" class="font-body font-semibold text-vintage-text">Description *</label>
            <Textarea 
          ...
          <div class="grid md:grid-cols-2 gap-4">
            <div class="flex flex-column gap-2">
              <label for="productPrice" class="font-body font-semibold text-vintage-text">Price (Rs.) *</label>
              <InputNumber 
                id="productPrice" 
            ...
            <div class="flex flex-column gap-2">
              <label for="productCategory" class="font-body font-semibold text-vintage-text">Category *</label>
              <Dropdown 
                id="productCategory" 
          ...
          <div class="flex flex-column gap-2">
            <label for="productImage" class="font-body font-semibold text-vintage-text">Image URL *</label>
            <InputText 
              id="productImage" 
            ...
            />
            <small class="text-vintage-accent">Tip: Use Unsplash or similar for high-quality images</small>
          </div>
          ...
          <div v-if="productForm.image_url" class="flex flex-column gap-2">
            ...
            />
            <small v-if="imageError" class="text-red-500">Failed to load image. Please check the URL.</small>
          </div>
      ...
      >
        <form @submit.prevent="saveCategory" class="space-y-4">
          <div class="flex flex-column gap-2">
            <label for="categoryName" class="font-body font-semibold text-vintage-text">Category Name *</label>
            <InputText 
              id="categoryName" 
